...
FEATURE_FLAGS: Dict[str, FlagDef] = {
    ...
    "ace_chat_floating": {"description": "Floating Ask ACE chat widget on all pages", "category": "experimental", "default_enabled": False, "enable_for_users": JUSDAVIS},
    "ace_chat_panel": {"description": "ACE assistant tab on account detail page", "category": "experimental", "default_enabled": False, "enable_for_users": JUSDAVIS},
