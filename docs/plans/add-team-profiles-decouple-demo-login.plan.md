...
MOCK_USERS: dict[str, CurrentUser] = {
    "jusdavis":      CurrentUser(user_id="jusdavis",      email="j.davis@snowflake.com",             display_name="Justin Davis",       role=UserRole.ACE,  is_admin=True),
    ...
    "dbaccus":       CurrentUser(user_id="dbaccus",       email="daunte.baccus@snowflake.com",        display_name="Daunte Baccus",      role=UserRole.ACEM),
...
if settings.spcs_mode:
    ...
    return CurrentUser(user_id="anonymous", email="anonymous@snowflake.com",
